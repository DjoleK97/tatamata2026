                ...
                <table class="table app-table-hover mb-0 text-left">
                  <thead class="text-center">
                    <tr>
                      ...
                      <th class="cell">Num of Chapters</th>
                    </tr>
                  </thead>
                  <tbody class="text-center">
                    <?php foreach ($courses as $index => $course) : ?>
                      <tr>
                        <td class="cell">
                          <a href="<?php echo BASE_URL . 'admin/courses/' . $course['id'] . '/chapters'; ?>">
                        ...
                        <td class="cell">
                          <a href="<?php echo BASE_URL . 'admin/courses/' . $course['id'] . '/chapters'; ?>">
                            <div>
                              <span class="truncate"><?php echo $course['name'] ?? "Error"; ?></span>
                            </div>
                          </a>
                        </td>
                        <td>
                          <a href="<?php echo BASE_URL . 'admin/courses/' . $course['id'] . '/chapters'; ?>">
                            <div>
                              <span class="truncate"><?php echo sizeof(Database::getInstance()->getAllChaptersForCourse($course['id'])); ?></span>
                            </div>
                          </a>
                        </td>
                      </tr>
