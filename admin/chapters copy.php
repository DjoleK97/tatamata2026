...
$chapters = Database::getInstance()->getAllChapters();
    ...
    <div class="container-xl">
      ...
      <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col">
          ...
          <h1 class="app-page-title mb-0">Chapters</h1>
        </div>
      </div>
      <!--//row-->
                  ...
                  <tbody>
                    <?php foreach ($chapters as $index => $chapter) : ?>
                      <tr>
                        ...
                        <td class="cell"><span class="truncate"><?php echo $chapter['name'] ?? "Error"; ?></span></td>
                        <td class="cell"><?php echo $chapter['chapter_name'] ?? "Clip Name"; ?></td>
                        <td class="cell"><?php echo $chapter['chapter_number'] ?? "Number"; ?></td>
                        <td class="cell">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <select name="course_id_edit" class="form-select" aria-label="Default select example">
                                          <?php foreach ($courses as $course) : ?>
                                            <option value="<?php echo $course['id'] ?? "1"; ?>" <?php if ($chapter['course_id'] == $course['id']) echo 'selected'; ?>><?php echo $course['name'] ?? "Error"; ?></option>
                                          <?php endforeach; ?>
                                        </select>
                                      </div>
